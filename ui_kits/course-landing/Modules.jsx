...
const ariumModules = [
  ...
  { n: '02', file: 'escopo.tsx', icon: 'target', title: 'Sua ideia, em tamanho realista', body: 'Escolher um problema pequeno o bastante para sair em um mês e valioso o bastante para alguém pagar. Definir o que entra na primeira versão. Pode ser um app de agendamento, um painel de clientes, uma ferramenta para o seu nicho: o método é o mesmo.', out: 'Um plano de uma página com as telas e funções do produto.' },
